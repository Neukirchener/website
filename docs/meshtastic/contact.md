...
Contact erleichtert die tägliche Arbeit mit Meshtastic Nodes und bietet unter anderem:

- Menübasierte Navigation statt langer CLI-Befehle,  
- Nachrichten senden und empfangen direkt im Terminal,  
...
Für die persistente Nutzung speichert Contact empfangene Nachrichten und Node‑Infos lokal in einer **SQLite‑Datenbank (`client.db`)**. Beim Neustart werden die Daten wieder geladen; ein Löschen der Datei setzt alles zurück. Damit ist Contact sowohl für Einsteiger als auch für erfahrene Nutzer geeignet, die regelmäßig mit Meshtastic arbeiten und dabei effizienter vorgehen möchten.
...
1. links: Kanäle
2. mittig: Nachrichtenfenster
3. rechts: Nodes im Mesh
...
In Kombination mit Cron lassen sich so regelmäßige Statusmeldungen realisieren, etwa alle 30 Minuten. Dadurch sehen andere Teilnehmer im Mesh sofort, welche Gateways aktuell aktiv sind.
