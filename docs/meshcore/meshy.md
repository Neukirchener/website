...
# Konfiguration
Über das "Hamburger-Menü" oder die Tastenkombination <kbd>Strg</kbd>+<kbd>5</kbd> gelangt man zu den Einstellungen. Hier die [Vorgaben](https://www.meshrheinland.de/meshcore/companion-setup) beachten und entsprechend einstellen. Diese Parameter sind entscheidend, damit Nachrichten zuverlässig zugestellt werden können.
